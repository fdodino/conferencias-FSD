export default class TalksService {
    ...
    insert(author, title, room) {
        this
            .talks
            .push({"author": author, "title": title, "room": room})
    }
    ...
    filter(value) {
        return this
            .talks
            .filter(talk => talk.author.toUpperCase().includes(value.toUpperCase()) || talk.title.toUpperCase().includes(value.toUpperCase()))
    }
